...
<head>
    ...
    <meta name="viewport" content="width=1020, maximum-scale=1.0, scalable=yes">

    <title>Royal Love - Responsive Wedding Template</title>
    <meta name="description" content="Romantic story or journey, wedding event, party schedule, rsvp form">
    <meta name="keywords" content="CycloneThemes">
    <meta name="author" content="CycloneThemes">
...
<body data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <header id="inner-navigation" style="display: none;">

        <nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function navbar-arrow">
            <div class="container">
                <div class="logo pull-left">
                    <a href="index.html"><img src="images/header/logo-2.png" alt></a>
                    <a href="index.html" class="sticky-logo"><img src="images/header/logo-1.png" alt></a>
                </div>
                <div id="navbar" class="navbar-nav-wrapper pull-right">
                    <ul class="nav navbar-nav navbar-right" id="responsive-menu">
                        <li>
                            ...
                            <ul>
                                <li><a href="index.html">Home Style <i class="fa fa-angle-right"></i></a>
                                    <ul>
                                ...
                                <li><a href="planner.html">Planner <i class="fa fa-angle-right"></i></a>
                                    <ul>
                                        <li><a href="planner.html">Planner 1</a></li>
                                        <li><a href="planner-1.html">Planner 2</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        <li class="active">
                            ...
                            <ul>
                                ...
                                <li><a href="about-us.html">Couple</a></li>
                        ...
                        <li>
                            <a href="#">Best People <i class="fa fa-angle-down"></i></a>
                            <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a href="blog-gridrightbar.html">Blog Grid</a></li>
                    ...
                    <div class="shopping-cart-holder">
                        <div class="shopping-cart-inner">
                            <a itemprop="url" class="header-cart header-cart-svg-path" href="#">
                                <span class="cart-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="17.998px"
                                        height="23.997px" viewBox="0 0 17.998 23.997"
                                ...
                                <ul>
                                    <li>
                                        <div class="item-image-holder">
                                            <a href="#&quot;"><img width="600" height="870"
                                                    src="images/gallery/thumb1-1.jpg"
                                    ...
                                    <li>
                                        <div class="cart-bottom">
                                            ...
                                            <div class="btn-holder clearfix">
                                                <div class="rt-checkout"><a href="checkout.html"> Checkout</a></div>
    ...
    <section class="breadcumb breadcumb-height breadcumb-bg-1">
        <div class="container text-center breadcumb-height">
            <div class="row breadcumb-height">
        ...
        <div class="seperator">
            <img src="images/body/layer-3.png" alt>
        </div>
    </section>


    <section id="about-us" class="section-padding aboutus-inner">
        <div class="container">
    ...
    <footer id="footer" class="footer-widgets">
        ...
        <center>
            <img src="images/val-banner.webp" alt="">
        </center>
    ...
    <script src="js/custom.ytplayer.js"></script>
    ...
    <script>
        (function () {
            var js =
                "window['__CF$cv$params']={r:'8506a7350aa80eb4',t:'MTcwNzA4ODkxOS44NTMwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";
